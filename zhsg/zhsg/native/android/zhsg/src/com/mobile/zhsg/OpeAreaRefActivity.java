...
public abstract class OpeAreaRefActivity extends UMWindowActivity {

	protected UMWindow OpeAreaRef = null;
...
protected XHorizontalLayout panel2 = null;
	...
	protected final static int ID_OPEAREAREF = 418421780;
protected final static int ID_VIEWPAGE0 = 2013675823;
protected final static int ID_NAVIGATORBAR0 = 2094409894;
protected final static int ID_BUTTON1 = 446765054;
protected final static int ID_LABEL0 = 1125540484;
protected final static int ID_SEARCH0 = 107061883;
protected final static int ID_LISTVIEWDEFINE0 = 1311246554;
protected final static int ID_PANEL0 = 1679019577;
protected final static int ID_PANEL1 = 1335446280;
protected final static int ID_LABEL1 = 1441545236;
protected final static int ID_LABEL2 = 423631780;
protected final static int ID_PANEL2 = 1899933811;

	
	
	@Override
	public String getControllerName() {
		return "OpeAreaRefController";
	}
...
this.setContentView(currentPage);
	...
	private void registerControl() {
		  idmap.put("OpeAreaRef",ID_OPEAREAREF);
  ...
  idmap.put("panel2",ID_PANEL2);
    ...
    UMEventArgs args = new UMEventArgs(OpeAreaRefActivity.this);
...
label1_binder.setBindInfo(new BindInfo("ope_area_no"));
...
OpeAreaRef = (UMWindow)ThirdControl.createControl(new UMWindow(context),ID_OPEAREAREF
,"halign","center"
,"height","fill"
,"layout","vbox"
,"width","fill"
,"controller","OpeAreaRefController"
,"namespace","com.mobile.zhsg"
);
View viewPage0 = (View) getViewPage0View((UMActivity)context,binderGroup,configure);
OpeAreaRef.addView(viewPage0);

return (UMWindow)OpeAreaRef;
}
