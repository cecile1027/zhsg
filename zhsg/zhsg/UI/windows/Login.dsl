...
<window xmlns:web="http://www.yonyou.com/uapmobile/dsl" id="Login" controller="LoginController" namespace="com.mobile.zhsg">
    ...
    <div id="viewPage0">
        <navigatorbar id="navigatorbar0" title="账号" class="navigatorbarclass">
            <label id="label0"/>
        ...
        <div id="panel0">
            ...
            <div id="panel1"/>
            <div id="panel2">
                <input id="textbox1" bindfield="password" maxlength="256" placeholder="密码" type="password" onchange="passwordChange()"/>
                <input id="showButton" visible="false" class="textbtnclass" onclick="showPassword()" type="button"/> 
            </div> 
        </div> 
    </div> 
</window>
