...
<window xmlns:web="http://www.yonyou.com/uapmobile/dsl" id="Home" controller="HomeController" namespace="com.mobile.zhsg">  
    ...
    <div id="viewPage0"> 
        <navigatorbar id="navigatorbar0" title="安全巡查" class="navigatorbarclass"> 
            <input id="button0" onclick="back()" type="button"/>  
            <label id="label0"/>  
        ...
        <div id="panel0"> 
            ...
            <flipper id="flipperdefine0" onnextflipper="next()" onload="load()" onpreviousflipper="previous()" viewindex="1"> 
                <div id="listpanel0" title="页面1"> 
                    <widget id="widget0" ref="TroubleListWidget" periodbg="#{color1}" bg="#{color0}"/> 
                </div>  
                <div id="listpanel1" title="页面2"> 
                    <widget id="widget1" ref="TroubleListWidget" periodbg="#{color1}" bg="#{color0}"/> 
                </div>  
                <div id="listpanel2" title="页面3"> 
                    <widget id="widget2" ref="TroubleListWidget" periodbg="#{color1}" bg="#{color0}"/> 
                </div>  
                <div id="listpanel3" title="页面4"> 
                    <widget id="widget3" ref="TroubleListWidget" periodbg="#{color1}" bg="#{color0}"/> 
                </div> 
            </flipper> 
        </div>  
        <div id="panel1"> 
